		...
		<c:choose>
			<c:when test="${not empty shippingAddresses}">
				<div style="padding-left: 5%; padding-right: 5%;">
						...
						<c:forEach items="${shippingAddresses}" var="shippingAddress">
							<div class="panel panel-primary">
								...
								<div class="panel-body">
									...
									<h4 class="text-muted"
										style="padding: 0px; margin: 0px; padding-bottom: 10px; padding-top: 10px;">Zip code</h4>
					...
					<a href="createShippingAddress" class="form-group btn btn-primary pull-right">Add new
						shipping address</a>
				</div>
			</c:when>
			<c:otherwise>
