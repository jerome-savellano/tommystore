...
<script type="text/javascript"
	src="<c:url value="/resources/js/customer_checkout.js"/>">
...
<div class="row"
	...
	<div class="checkout-success"  style="display: none">
		<div class="alert alert-success fade in">
			...
			<strong>Success!</strong> Checkout done! Continue shopping at Tommy's
			Store!
		</div>
		<div class="text-center">
			<h3 class="text-muted">Cart is empty. Continue shopping at
				Tommy's store!</h3>
			<a href="home" class="form-group btn btn-lg btn-warning">Continue
				shopping</a>
		</div>
	</div>
	<div class="alert alert-danger fade in checkout-failed"
		style="display: none">
		<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
		<strong>Failed!</strong> Checkout failed! Please check the stocks of
		the products in your cart. Make sure we have sufficient stocks for
		...
		<div class="col-md-12">
			<div class="form-inline pull-right">
				<form action="checkout" method="post">
					<button class="form-group btn btn-lg btn-primary">Checkout</button>
					<a href="viewCart" class="form-group btn btn-lg btn-warning">Back
						to cart</a>
				</form>
			</div>
		</div>
