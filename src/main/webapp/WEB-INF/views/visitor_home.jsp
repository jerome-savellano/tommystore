...
<body>
	<div class="container">
		<jsp:include page="visitor_header.jsp"></jsp:include>
		<c:if test="${activePage  == 'HOME'}">
			<jsp:include page="visitor_view_products.jsp"></jsp:include>
		</c:if>
		<c:if test="${activePage  == 'VIEW_CART'}">
			<jsp:include page="visitor_view_cart.jsp"></jsp:include>
		</c:if>
		<c:if test="${activePage  == 'CATEGORIES'}">
			<jsp:include page="visitor_categories.jsp"></jsp:include>
		</c:if>
	</div>
</body>
</html>